<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Brand.aspx.cs" Inherits="GSTBillingSystem.Brand1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="slim-pageheader">
            ...
            <h6 class="slim-pagetitle">Add Brand</h6>
        </div>
        <!-- slim-pageheader -->
        ...
        <div class="section-wrapper mg-t-15">
            ...
            <div class="form-layout">
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mg-b-10-force">
                            <asp:DropDownList runat="server" CssClass="form-control" data-placeholder="Select Category" ID="ddlCategory">
                            </asp:DropDownList><br />
                            <asp:RequiredFieldValidator ErrorMessage="select category" InitialValue="0" ForeColor="Red" ControlToValidate="ddlCategory" runat="server" ValidationGroup="addBrand" />
                        </div>
                    </div>
                    <!-- col-4 -->
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="icon ion-filing tx-20 lh-0 op-6"></i></span>
                            </div>
                            <%--<input type="text" class="form-control" placeholder="Brand name">--%>
                            <asp:TextBox ID="BrandName" runat="server" CssClass="form-control" placeholder=" Enter Brand Name"></asp:TextBox><br />
                            <div class="col-sm-12">
                            <asp:RequiredFieldValidator ErrorMessage="Enter Brand Name" ForeColor="Red" ControlToValidate="BrandName" runat="server"  ValidationGroup="addBrand" />
                        </div>
                            </div>
                        <!-- input-group -->
                    </div>
                   ...
                   <%-- <div class="col-lg-4">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="BrandShortName" runat="server" CssClass="form-control" placeholder=" Enter Brand Short Name" /><br />
                           <div class="col-sm-12">
                             <asp:RequiredFieldValidator ErrorMessage="Enter Brand Short Name" ForeColor="Red" ControlToValidate="BrandShortName" runat="server"  ValidationGroup="addBrand" />
                       </div>
                                </div>
                        <!-- input-group -->
                    </div>
                ...
                <div class="form-layout-footer pd-y-20 tx-center">
                    <%-- <button class="btn btn-primary bd-0" style="margin-right: 100px">Add</button>--%>

                    <asp:Button ID="Button1" Text="Add" runat="server" CssClass="btn btn-primary bd-0" Style="margin-right: 100px" OnClick="Button1_Click"  ValidationGroup="addBrand" />
                ...
                <div class="table-wrapper">
                    ...
                    <asp:GridView runat="server" ID="gridview1" DataKeyNames="BrandId" CssClass="table table-bordered table-striped display responsive nowrap" OnRowDeleting="gridview1_RowDeleting1" AutoGenerateColumns="false">
                        <Columns>
                            <asp:TemplateField HeaderText="Sr. No.">
                                <ItemTemplate>
                                    <asp:Label Text='<%# Eval("BrandId") %>' runat="server" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="Brand Name">
                                <ItemTemplate>
                                    <asp:Label ID="Label4" Text='<%# Eval("BrandName") %>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <%--<asp:TemplateField HeaderText="Brand Short Name">
                                <ItemTemplate>
                                    <asp:Label ID="Label5" Text='<%# Eval("BrandShortName") %>' runat="server" />
                                </ItemTemplate>
